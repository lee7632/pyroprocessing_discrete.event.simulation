...
class product_storage_class(facility_component_class):
    ...
    def process_batch(self,facility,batch):
        ...
        self.true_campaign_inventory = self.true_campaign_inventory + batch.true_weight
        self.expected_campaign_inventory = self.expected_campaign_inventory + batch.expected_weight
        self.true_cumulative_inventory = self.true_cumulative_inventory + self.true_campaign_inventory
        self.expected_cumulative_inventory = self.expected_cumulative_inventory + self.expected_campaign_inventory
