...
class kmp_class(facility_component_class):
    ...
    def kmp_measurement(self,facility_vars,equipment_failure_time_0,equipment_failure_time_1,kmp_delay_time,uncertainty,threshold,true_quantity,expected_quantity,measured_inventory,measured_system_inventory,kmp_identifier,log_file):
    ...
    ###
        if (kmp_identifier==0):
            return(facility_vars.operation_time,equipment_failure_time_0,equipment_failure_time_1,measured_quantity,measured_inventory,measured_initial_inventory,measured_system_inventory)
        else:
            return(facility_vars.operation_time,equipment_failure_time_0,equipment_failure_time_1,measured_quantity,measured_inventory)
