...
# Part of the design process is establishing material balance areas (MBAs) and KMPs.
#
# More KMPs = more time not processing material. 
# Too few KMPs could result in materials accounting errors, and result in higher probability of false alarms. 
# 
########################################################################
#
# Assumptions
