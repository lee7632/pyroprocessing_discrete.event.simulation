...
#
    numpy.savetxt('..\\..\\output\\fuel.fabrication\\process.failures.out',process_failures_output,fmt=['%.4f','%.2f'],header='Failure probability\tMaintenance time (h)',comments='',delimiter='\t\t\t')
    numpy.savetxt('..\\..\\output\\fuel.fabrication\\inspection.time.out',inspection_time_output,fmt=['%.2f'],header='Inspection time (h)',comments='')
    numpy.savetxt('..\\..\\output\\fuel.fabrication\\measurement.kmp.out',measurement_kmp_output,fmt=['%.0f','%.4f','%.2f','%.4f'],header='KMP\tMeasurement uncertainty\tMeasurement delay time (h)\tMeasurement threshold',comments='',delimiter='\t\t\t')
    numpy.savetxt('..\\..\\output\\fuel.fabrication\\system.false.alarm.out',system_false_alarm_output,fmt=['%.4f'],header='Fraction of MUF to trigger alarm for system inspection',comments='')
    numpy.savetxt('..\\..\\output\\fuel.fabrication\\melter.cleaning.time.out',melter_cleaning_time_output,fmt=['%.4f'],header='Time to clean the melter additional to maintenance activity (h)',comments='')
###
...
def open_files():
###
    time_output=open('..\\..\\output\\facility.operation.time.out','w+')
    campaign_output=open('..\\..\\output\\facility.campaign.out','w+')
    true_storage_inventory_output=open('..\\..\\output\\true.storage.inventory.out','w+')
    expected_storage_inventory_output=open('..\\..\\output\\expected.storage.inventory.out','w+')
    measured_storage_inventory_output=open('..\\..\\output\\measured.storage.inventory.out','w+')
    true_weight_output=open('..\\..\\output\\true.weight.out','w+')
    expected_weight_output=open('..\\..\\output\\expected.weight.out','w+')
    measured_weight_output=open('..\\..\\output\\measured.weight.out','w+')
    true_muf_output=open('..\\..\\output\\true.muf.out','w+')
    expected_muf_output=open('..\\..\\output\\expected.muf.out','w+')
    measured_muf_output=open('..\\..\\output\\measured.muf.out','w+')
    true_mufc_output=open('..\\..\\output\\true.mufc.out','w+')
    expected_mufc_output=open('..\\..\\output\\expected.mufc.out','w+')
    measured_mufc_output=open('..\\..\\output\\measured.mufc.out','w+')
    true_processed_inventory_output=open('..\\..\\output\\true.processed.inventory.out','w+')
    expected_processed_inventory_output=open('..\\..\\output\\expected.processed.inventory.out','w+')
    measured_processed_inventory_output=open('..\\..\\output\\measured.processed.inventory.out','w+')
    total_melter_failure_output=open('..\\..\\output\\total.melter.failures.out','w+')
    system_false_alarm_counter_output=open('..\\..\\output\\system.false.alarm.counter.out','w+')
    true_kmp0=open('..\\..\\output\\true.kmp0.out','w+')
    true_kmp1=open('..\\..\\output\\true.kmp1.out','w+')
    true_kmp2=open('..\\..\\output\\true.kmp2.out','w+')
    true_kmp3=open('..\\..\\output\\true.kmp3.out','w+')
    true_kmp4=open('..\\..\\output\\true.kmp4.out','w+')
    expected_kmp0=open('..\\..\\output\\expected.kmp0.out','w+')
    expected_kmp1=open('..\\..\\output\\expected.kmp1.out','w+')
    expected_kmp2=open('..\\..\\output\\expected.kmp2.out','w+')
    expected_kmp3=open('..\\..\\output\\expected.kmp3.out','w+')
    expected_kmp4=open('..\\..\\output\\expected.kmp4.out','w+')
    measured_kmp0=open('..\\..\\output\\measured.kmp0.out','w+')
    measured_kmp1=open('..\\..\\output\\measured.kmp1.out','w+')
    measured_kmp2=open('..\\..\\output\\measured.kmp2.out','w+')
    measured_kmp3=open('..\\..\\output\\measured.kmp3.out','w+')
    measured_kmp4=open('..\\..\\output\\measured.kmp4.out','w+')
    true_heel=open('..\\..\\output\\true.heel.out','w+')
    expected_heel=open('..\\..\\output\\expected.heel.out','w+')
    measured_heel=open('..\\..\\output\\measured.heel.out','w+')
    true_system_inventory_output=open('..\\..\\output\\true.system.inventory.out','w+')
    expected_system_inventory_output=open('..\\..\\output\\expected.system.inventory.out','w+')
    measured_system_inventory_output=open('..\\..\\output\\measured.system.inventory.out','w+')
###
